# Copyright (C) 2016 The python-litecoinlib developers
#
...
class Test_Segwit(unittest.TestCase):
    ...
    def test_checkblock(self):
        # (No witness) coinbase generated by Litecoin Core
        ...
        commitment_script = litecoin.core.WITNESS_COINBASE_SCRIPTPUBKEY_MAGIC + commitment
